        ...
        return (
            <section className="w-full py-8">
                <div className="relative w-full overflow-hidden mb-8">
                    <div className="flex flex-wrap gap-2  pb-2 px-2 md:px-4 md:justify-center"
                ...
                <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-4">
                    {Array.from({ length: 8 }).map((_, i) => (
                        <div key={i} className="h-[250px] w-[280px] bg-primary/20 rounded-xl animate-pulse" />
                    ))}
                </div>
            </section>
        );
                ...
                {sortedProducts.length > 0 ? (
                    ...
                    >
                        ...
                        <p className="text-xs text-[#8A857D] max-w-[280px] leading-relaxed">
                            We are currently updating our collection with fresh arrivals. Please
                            check back shortly or explore our other categories!
                        </p>
                        <button
                            onClick={() => setSelectedCategory(null)}

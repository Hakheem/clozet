...
import { updateProduct, type GenderType, type ProductStatus, type ProductVariantType, type VariantInput, type ProductWithCategory } from "@/actions/products";
...
export default function EditProductForm({ product, redirectPath = "/admin/products" }: { product: any, redirectPath?: string }) {
  ...
  const [form, setForm] = useState({
    ...
    variantType: product.variantType as ProductVariantType,
    brand: product.brand || "",
      ...
      <header className="sticky top-0 z-20 bg-white border-b border-[#E4E0D9] px-8 h-20 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <nav className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#8A857D]">
            ...
            <span className="text-[#1C1A17]">Edit {product.name}</span>
          </nav>
        </div>
      ...
      <div className="max-w-5xl mx-auto p-10">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Media */}
            <Section title="Visual Assets" description="Update your photos." icon={ImageIcon}>
              <ProductImageUpload 
                value={form.images}
            ...
            <Section title="Classification" description="Categorize and target your audience." icon={Layers}>
              ...
              <Field label="Product Status">
                <div className="relative">
                  <Select 
                    value={form.status}
                    onChange={(e: any) => setForm({ ...form, status: e.target.value as ProductStatus })}
                  >
          ...
          <div className="lg:col-span-3 grid grid-cols-1 lg:grid-cols-3 gap-8 pt-8 border-t border-[#E4E0D9]">
            ...
            <div className="lg:col-span-2">
              <Section title="Variants" description="Manage sizes and colors." icon={Package}>
                <VariantManager 

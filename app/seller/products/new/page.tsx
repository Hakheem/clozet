    ...
    <div className="min-h-full bg-[#F7F5F2]">
      ...
      <header className="sticky top-0 z-20 bg-white border-b border-[#E4E0D9] px-8 h-20 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/seller/products" className="w-10 h-10 rounded-full flex items-center justify-center hover:bg-[#F7F5F2] transition-colors border border-transparent hover:border-[#E4E0D9]">
          ...
          <nav className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#8A857D]">
            <Link href="/seller/products" className="hover:text-[#1C1A17] transition-colors">My Products</Link>
      ...
      <div className="max-w-5xl mx-auto p-10">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* General Info */}
            <Section title="Product Details" description="Define your new listing." icon={Package}>
            ...
            {/* Media */}
            <Section title="Visual Assets" description="Upload product photos." icon={ImageIcon}>
              <ProductImageUpload 
                value={form.images}
          ...
          <div className="lg:col-span-1 space-y-8">
            {/* Classification */}
            <Section title="Classification" description="Where does this fit?" icon={Layers}>

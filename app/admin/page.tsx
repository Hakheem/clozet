...
import { UserDropdown } from "@/components/auth/UserDropdown"; // if we want them to log out from here
    ...
    <div className="min-h-screen bg-zinc-50">
      <header className="bg-white border-b border-zinc-200">
        <Container className="flex items-center justify-between h-16">
          <h2 className="text-xl font-bold font-title text-zinc-900">Admin Control Center</h2>
        </Container>
      </header>
      ...
      <Container className="py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="p-6 bg-white border border-zinc-200 rounded-xl shadow-sm text-center">
                <p className="text-sm text-zinc-500 font-medium">Pending Payouts</p>
                <h3 className="text-3xl font-bold font-title mt-2">0</h3>
            </div>
            <div className="p-6 bg-white border border-zinc-200 rounded-xl shadow-sm text-center">
                <p className="text-sm text-zinc-500 font-medium">Active Listings</p>
                <h3 className="text-3xl font-bold font-title mt-2">0</h3>
            </div>
        </div>

        <div className="mt-10 p-6 bg-white border border-zinc-200 rounded-xl min-h-[400px]">
            <p className="text-zinc-500 text-sm">Dashboard components will load here...</p>
        </div>
      </Container>
    </div>
  );
